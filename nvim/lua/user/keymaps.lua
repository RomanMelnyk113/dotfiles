...
vim.api.nvim_set_keymap("n", "mh", "<cmd>lua require('telescope.builtin').extensions.harpoon.marks(require('telescope.themes').get_dropdown{previewer = false, initial_mode='normal'})<cr>", opts)
...
vim.api.nvim_set_keymap("n", "mh", "<cmd>lua require('harpoon.ui').toggle_quick_menu()<cr>", opts)
