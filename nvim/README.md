# My Neovim Config 
## Note: this was mostly copied from amazing [ChristianChiarulli](https://github.com/ChristianChiarulli/nvim) repo)


## Try out this config

Download nvim folder from this repo but make sure to remove or move your current `nvim` directory before
